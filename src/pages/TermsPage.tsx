    ...
    <div className="min-h-screen bg-sand-50 pb-20">
      ...
      <div className="container mx-auto px-4 py-16 -mt-10 relative z-20">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 md:p-12 lg:p-16 border border-gray-100">
          ...
          <div className="prose prose-lg prose-headings:text-navy-900 prose-headings:font-heading max-w-none text-navy-700">
            ...
            <div className="mb-12 flex gap-6 items-start">
              <div className="bg-navy-50 p-3 rounded-xl shrink-0 mt-1">
                <CheckCircle className="w-6 h-6 text-navy-700" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">1. Acceptance of Terms</h2>
                <p>
            ...
            <div className="mb-12 flex gap-6 items-start">
              ...
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">2. Services Description</h2>
                <p>
            ...
            <div className="mb-12 flex gap-6 items-start">
              <div className="bg-navy-50 p-3 rounded-xl shrink-0 mt-1">
                <AlertCircle className="w-6 h-6 text-navy-700" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">3. User Responsibilities</h2>
            ...
            <div className="mb-12 flex gap-6 items-start">
              ...
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">4. Payment Terms</h2>
                <p>
            ...
            <div className="mb-12 flex gap-6 items-start">
              ...
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">5. Cancellation Policy</h2>
                <p>
            ...
            <div className="mb-12 flex gap-6 items-start">
              ...
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-4 mt-0">6. Limitation of Liability</h2>
                <p>
            ...
            <div className="bg-teal-50 rounded-2xl p-8 border border-teal-100 flex gap-6 items-start mt-16">
              <div className="bg-white p-3 rounded-xl shrink-0 mt-1 shadow-sm">
                <Mail className="w-6 h-6 text-teal-600" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-navy-900 mb-2 mt-0">7. Contact Information</h2>
                <p className="mb-0">
                  If you have any questions about these Terms and Conditions, please contact us at:
                </p>
                <a href="mailto:legal@royaleducation.com" className="inline-block mt-4 text-teal-600 font-bold hover:text-teal-700">
